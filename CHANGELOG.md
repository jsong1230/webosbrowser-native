...
**전체 15개 기능 완료, webOS 프로젝터 배포 준비 완료**
...
#### 개발 환경 개선
- WebView 스텁 시각화 (URL 로드 시 색상 변경, 카운터 표시)
- SecurityIndicator 텍스트 아이콘 (🔒, ⚠️, ℹ️)
- URLBar 디버그 로그 추가
- DEPLOY_GUIDE.md 작성
...
- **빌드**: CMake 3.16+
- **플랫폼**: webOS 6.x
- **소스**: 24개 파일, 1.1MB 실행 파일

#### 알려진 제한사항
- Mac: WebView 스텁 (실제 렌더링 없음)
- webOS: Qt WebEngine 필요 (없으면 스텁 모드)
- 다운로드 기능: WebEngine 조건부 빌드
